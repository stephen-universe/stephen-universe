  ...
  return (
     <div style={{ width: '100%', height: '100%', background: '#253237' }}>
      ...
      <div className="section-divider"></div> 
        ...
        <ParallaxLayer offset={2} speed={1} style={{ backgroundColor: '#805E73', zIndex: -1 }} />
        <ParallaxLayer offset={4.1} speed={1} style={{ backgroundColor: '#87BCDE' }} />
        ...
        >    <section className="main-body-bg"><div className="container"><Introduction /></div></section>
        </ParallaxLayer>
