...
export default function InitializeContact() {  
    return (
      ...
      <>
    <div className=" orange bold has-text-centered" style={{marginTop: 4.5 + "rem"}}>

    <div className="">
        <Fade cascade duration={2000} delay={800}><span>Feel Free To Explore Around</span></Fade> <br/>
        <Fade cascade duration={1500} delay={1400}><span style={{fontSize: 2 + 'rem'}}>And When Ready, <span> <br/>
