...
// Dynamically import FooterQuote with no SSR
const FooterQuote = dynamic(() => import("./footerQuote"), {
  ssr: false,
});
...
export default function ThreeShape() {
  ...
  useEffect(() => {
    ...
    const positions = [
      [-6, 8, -3.2], [7.6, 4.8, -4], [-8, -9.6, 4], [-6.4, 8.8, 6.4],
      [-8, -5.6, 4.8], [-11.2, 6.4, -7.2], [-2.4, -4, -4.8],
      [12, -1.6, -5.6], [8.8, 1.6, 8], [10.4, -8, 6.4],
      [4.8, -8.8, -4.8], [-9.6, 4, -1.6],
    ];

    for (let i = 0; i < positions.length; i++) {
      const scaleFactor = (Math.random() * 0.4 + 0.6) * 1.65 * 1.25;
